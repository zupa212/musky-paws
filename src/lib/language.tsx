...
const translations: Record<Locale, Record<string, string>> = {
    el: {
        ...
        'testimonials.q1': 'Απίστευτη δουλειά. Επαγγελματίες και πιο συγκεκριμένα το σκυλί αισθάνθηκε πολύ οικεία και πέρασε ευχάριστα. Δημήτρης Δ.',
        ...
        'testimonials.q3': 'Η εμπειρία μου με την Στέλλα εξαιρετική από την αρχή έως το τέλος! Είναι εξαιρετικά φιλική και επαγγελματική, κάνοντάς μας να αισθανθούμε άνετα. Βάσω Α.',
        'testimonials.q4': 'Υπέροχος χώρος, επαγγελματικό περιβάλλον με όμορφο γούστο, άψογες παροχές με τη Στέλλα να αντιμετωπίζει το κατοικίδιο μου με εξαιρετική φροντίδα. Σοφία Β.',
        ...
        'testimonials.q6': 'Εξαιρετική επαγγελματίας!! Η Στέλλα είναι πολύ προσεκτική, αγαπά πραγματικά τα ζώα και το αποτέλεσμα στο grooming ήταν άψογο!! Σοφία Μ.',
    ...
    en: {
        ...
        'testimonials.q1': 'Incredible work. Professionals and more specifically the dog felt very familiar and had a pleasant time. Dimitris D.',
