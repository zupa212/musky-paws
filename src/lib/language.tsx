...
const translations: Record<Locale, Record<string, string>> = {
    el: {
        ...
        'hero.subtitle': 'Ήρεμη, προσεγμένη περιποίηση για σκύλους, σε έναν καθαρό και ασφαλή χώρο στην Περαία.',
        ...
        'testimonials.q1': 'Υπέροχος χώρος, επαγγελματικό περιβάλλον με όμορφο γούστο, άψογες παροχές με τη Στέλλα να αντιμετωπίζει το κατοικίδιο μου με εξαιρετική φροντίδα, υπομονή και αγάπη! Τη συστήνω ανεπιφύλακτα! Εμείς σίγουρα θα ξαναπάμε!!',
    ...
    en: {
        ...
        'testimonials.q1': 'Wonderful space, professional environment with beautiful taste, impeccable facilities with Stella treating my pet with extreme care, patience and love! I highly recommend her! We will definitely go back!!',
