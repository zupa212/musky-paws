                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-lg text-brand-700 dark:text-brand-300 mb-6 leading-relaxed">
                                Γεια σας! Είμαι η Στέλλα, η δημιουργός και Certified Groomer του Musky Paws. Η τεράστια αγάπη μου για τα ζώα με οδήγησε στο να φτιάξω έναν χώρο στην Περαία που θα είναι κάτι παραπάνω από ένα απλό κομμωτήριο σκύλων.
                            </p>
                            <p className="text-lg text-brand-700 dark:text-brand-300 mb-6 leading-relaxed">
                                Όραμά μου ήταν να δημιουργήσω ένα απολύτως stress-free περιβάλλον, όπου κάθε σκυλάκι θα νιώθει σαν στο σπίτι του. Χωρίς βία, χωρίς βιασύνη, αλλά με αληθινό ενδιαφέρον και αγκαλιές. Στο Musky Paws, ο φίλος σας απολαμβάνει μια ήρεμη εμπειρία spa, φτιαγμένη με σεβασμό στις δικές του, μοναδικές ανάγκες.
                            </p>
