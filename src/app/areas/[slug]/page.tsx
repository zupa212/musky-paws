...
const areaData = {
    ...
    'trilofos': {
        name: 'Τρίλοφος',
        heading: 'Dog Grooming & Spa Σκύλων για Κατοίκους Τριλόφου',
        description: 'Μόλις λίγα χιλιόμετρα από τον Τρίλοφο, το κομμωτήριο σκύλων Musky Paws προσφέρει εξειδικευμένες υπηρεσίες περιποίησης (μπάνιο, κούρεμα, deshedding) σε ένα καθαρό και ήρεμο περιβάλλον.',
        time: '12 λεπτά με το αυτοκίνητο',
        distance: '9 χλμ'
    },
    'epanomi': {
        name: 'Επανομή',
        heading: 'Το Καλύτερο Κομμωτήριο Σκύλων Κοντά Στην Επανομή',
        description: 'Ψάχνετε τον ιδανικό groomer κοντά στην Επανομή; Η ομάδα μας αναλαμβάνει τον πλήρη καλλωπισμό και την υγιεινή του σκύλου σας στο πολυτελές κατάστημά μας στην Περαία.',
        time: '14 λεπτά με το αυτοκίνητο',
        distance: '11 χλμ'
    },
    'nea-michaniona': {
        name: 'Νέα Μηχανιώνα',
        heading: 'Pet Grooming & Κούρεμα Σκύλου για τη Νέα Μηχανιώνα',
        description: 'Σε μικρή απόσταση από τη Νέα Μηχανιώνα, παρέχουμε στο σκυλάκι σας premium περιποίηση, με κορυφαία υποαλλεργικά προϊόντα και απόλυτο σεβασμό στον ρυθμό του, χωρίς κανένα άγχος.',
        time: '15 λεπτά με το αυτοκίνητο',
        distance: '10 χλμ'
    },
    'thermi': {
        name: 'Θέρμη',
        heading: 'Υψηλών Προδιαγραφών Grooming για Σκύλους Από Τη Θέρμη',
        description: 'Για τους κηδεμόνες από τη Θέρμη που ζητούν το καλύτερο αποκλείοντας τη νάρκωση. Η σύγχρονη προσέγγισή μας στην περιποίηση φέρνει πολλούς πελάτες στο χώρο μας, δημιουργώντας σχέσεις εμπιστοσύνης.',
        time: '20 λεπτά με το αυτοκίνητο',
        distance: '16 χλμ'
    },
    'plagiari': {
        name: 'Πλαγιάρι',
        heading: 'Φροντίδα Σκύλων: Επιλογή #1 Για Τους Κατοίκους Στο Πλαγιάρι',
        description: 'Έρχεστε από το Πλαγιάρι; Το Musky Paws βρίσκεται δίπλα σας! Κλείστε εύκολα ραντεβού online και προσφέρετε στο αγαπημένο σας κατοικίδιο ένα πλήρες ολοκληρωμένο πακέτο καλλωπισμού.',
        time: '8 λεπτά με το αυτοκίνητο',
        distance: '6 χλμ'
    },
    'neoi-epivates': {
        name: 'Νέοι Επιβάτες',
