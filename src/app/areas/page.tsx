...
const areas = [
    ...
    { name: 'Τρίλοφος', slug: 'trilofos', desc: 'Μόλις λίγα λεπτά μακριά από τον Τρίλοφο βρίσκετε το καλύτερο spa για τον σκύλο σας.' },
    { name: 'Επανομή', slug: 'epanomi', desc: 'Η κορυφαία επιλογή για υψηλών προδιαγραφών grooming στην περιοχή της Επανομής.' },
    { name: 'Νέα Μηχανιώνα', slug: 'nea-michaniona', desc: 'Πολύ κοντά στη Μηχανιώνα, προσφέρουμε μπάνιο και κούρεμα χωρίς άγχος.' },
    { name: 'Θέρμη', slug: 'thermi', desc: 'Η αξία της σωστής φροντίδας του κατοικιδίου σας αξίζει τη σύντομη διαδρομή από τη Θέρμη.' },
    { name: 'Πλαγιάρι', slug: 'plagiari', desc: 'Εξυπηρετούμε καθημερινά πελάτες από το Πλαγιάρι που εμπιστεύονται την εμπειρία μας.' },
