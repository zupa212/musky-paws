...
const servicesData = {
    ...
    'small-breed-grooming': {
        ...
        h1: 'Κούρεμα Μικρόσωμου Σκύλου στην Περαία Θεσσαλονίκης',
        seoTitle: 'Κούρεμα Μικρόσωμου Σκύλου Περαία | Maltese, Poodle, Yorkshire | Musky Paws',
        seoDesc: 'Εξειδικευμένο κούρεμα μικρόσωμου σκύλου στην Περαία για Maltese, Poodle, Bichon, Yorkshire και Shih Tzu, με stress-free handling και σωστή συντήρηση τριχώματος.',
        description: 'Εξειδικευμένη υπηρεσία για μικρόσωμες φυλές που χρειάζονται τακτικό styling, προσεκτικό βούρτσισμα και σωστή πρόληψη κόμπων. Ιδανική για σκύλους με τρίχωμα που μακραίνει και απαιτεί συνέπεια.',
        duration: 'Με βάση φυλή και τρίχωμα',
        price: 'Κατόπιν εκτίμησης',
        img: 'https://images.unsplash.com/photo-1517849845537-4d257902454a?auto=format&fit=crop&q=80',
        forWhom: 'Για Maltese, Poodle, Bichon Frise, Yorkshire Terrier, Shih Tzu και παρόμοιες μικρόσωμες φυλές που χρειάζονται συχνό grooming για να διατηρείται το τρίχωμα όμορφο και λειτουργικό.',
        steps: [
            'Έλεγχος κατάστασης τριχώματος και εντοπισμός κόμπων',
            'Συζήτηση για μήκος, πρακτικότητα και συχνότητα συντήρησης',
            'Μπάνιο και προσεκτικό στέγνωμα με παράλληλο βούρτσισμα',
            'Styling σύμφωνα με τη φυλή ή την καθημερινότητα του ιδιοκτήτη',
            'Καθαρισμός αυτιών, νύχια και τελικό φινίρισμα'
        ],
        faqs: [
            { q: 'Κάθε πότε χρειάζεται κούρεμα ένα μικρόσωμο σκυλί;', a: 'Στις περισσότερες μικρόσωμες φυλές, το σωστό διάστημα είναι περίπου κάθε 4 έως 6 εβδομάδες ώστε να προλαμβάνονται κόμποι και δύσκολη συντήρηση στο σπίτι.' },
            { q: 'Μπορεί να γίνει πρακτικό κούρεμα αντί για πολύ fancy styling;', a: 'Ναι. Η σωστή προσέγγιση είναι να προσαρμόζεται το κούρεμα στις ανάγκες της οικογένειας, στο πόσο βούρτσισμα γίνεται στο σπίτι και στο τρίχωμα του κάθε σκύλου.' }
        ]
    }
};
